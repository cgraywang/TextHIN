...
public class CoreNLPAnalyzer extends LanguageAnalyzer {
  public static class Options {
    ...
    public List<String> annotators = Lists.newArrayList("tokenize", "ssplit", "pos", "lemma", "ner", "parse", "regexner");
  ...
  public static void initModels() {
    ...
    String threadNum = "5";
//    LogInfo.logs("thread num = " + threadNum);
    props.put("thread", threadNum);
