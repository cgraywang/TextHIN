...
//	  System.out.println(uri);
	if (uri.startsWith(owlNamespace)) {
		return "owl:" + uri.substring(owlNamespace.length());
	}
	if (uri.startsWith(yagoNamespace)) {
		return "YAGO:" + uri.substring(yagoNamespace.length());
	}
