package edu.pku.dlib.models.util;

import java.util.logging.Logger;

// Maintain a maxheap to find k-nearest neighbors.
public class MaxHeap{
	...
	public MaxHeap(int[] indices, double[] values, int cap) {
	...
	public static int[] heapSort(MaxHeap maxHeap) {
