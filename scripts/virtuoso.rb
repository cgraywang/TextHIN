...
def start
  ...
  numberOfBuffers = parseInt(memFree * 0.5 / 8)
...
DirsAllowed  = ., /usr/local/virtuoso-opensource/share/virtuoso/vad, /home/wcg/yago3/useful
...
EOF
  ...
  out.puts config
  out.close
  run "virtuoso-t +configfile #{configPath} +wait"
end
