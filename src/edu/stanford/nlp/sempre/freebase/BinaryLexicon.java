...
//        if (entries.get(i).formula.toString().contains("religion.deity.deity_of") | entries.get(i).formula.toString().contains("government_position_held"))
//        	LogInfo.logs("binary:%s for %s", textDesc, entries.get(i).formula);
      }
