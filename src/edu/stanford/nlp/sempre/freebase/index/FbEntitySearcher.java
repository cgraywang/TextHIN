...
public class FbEntitySearcher {
  ...
  public static void main(String[] args) throws IOException, ParseException {
    ...
    FbEntitySearcher searcher = new FbEntitySearcher("lib/lucene/4.4/inexact", 1000, "inexact");
...
//    	  if (! doc.get(FbIndexField.ID.fieldName()).contains("democrat_party"))
//    		  continue;
    	  if (  Double.parseDouble(doc.get(FbIndexField.POPULARITY.fieldName())) <0.0001)
    		  continue;
